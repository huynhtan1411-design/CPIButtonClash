...
namespace UISystems
{
    ...
    public class UIManagerEditor : Editor
    {
        ...
        private void ShowCanvases()
        {
            ...
            Utils.ShowSerializedField(serializedObject, "MENUGAME", "MenuGame");
            Utils.ShowSerializedField(serializedObject, "MENUPAUSE", "MenuPause");
            ...
            Utils.ShowSerializedField(serializedObject, "NOTIBOX", "NotiBox");
            Utils.ShowSerializedField(serializedObject, "shopManager", "Shop Manager");
            Utils.ShowSerializedField(serializedObject, "TUTORIAL", "Tutorial");
            Utils.ShowSerializedField(serializedObject, "LOADING", "Loading");
            Utils.ShowSerializedField(serializedObject, "REWARDITEM", "REWARDITEM");
        ...
        private void ShowMenuUI()
        {
            ...
            Utils.ShowSerializedField(serializedObject, "isShowStart");
            Utils.ShowSerializedField(serializedObject, "coinsTexts");
        }
        ...
        private void ShowGameUI()
        {
            ...
            Utils.ShowSerializedField(serializedObject, "progressNot");
            Utils.ShowSerializedField(serializedObject, "gameCoinsText");
            Utils.ShowSerializedField(serializedObject, "levelText");
            Utils.ShowSerializedField(serializedObject, "timerLoading");
        }
        ...
        private void ShowLevelCompleteUI()
        {
            ...
            Utils.ShowSerializedField(serializedObject, "effectCompletes");
        }
    }
}
#endif